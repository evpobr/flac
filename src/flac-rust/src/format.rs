...
extern "C" {
    ...
    pub static VERSION_STRING: *const c_char;

    #[name("FLAC__VENDOR_STRING")]
    pub static VENDOR_STRING: *const c_char;

    #[name("FLAC__STREAM_SYNC_STRING")]
    pub static STREAM_SYNC_STRING: [u8; 4];

    #[name("FLAC__VENDOR_STRING")]
    pub static STREAM_SYNC: u32;

    #[name("FLAC__STREAM_SYNC_LEN")]
    pub static STREAM_SYNC_LEN: u32;
    
}

pub const STREAM_SYNC_LENGTH: u32 = 4u;
...
extern "C" {
    ...
    pub static EntropyCodingMethodTypeString: *const *const c_char;
}
...
pub struct FLAC__EntropyCodingMethod_PartitionedRice {
	pub order: u32,
	pub contents: *const EntropyCodingMethod_PartitionedRiceContents,
}

extern "C" {
	#[name("FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE_ORDER_LEN")]
	pub static ENTROPY_CODING_METHOD_PARTITIONED_RICE_ORDER_LEN: u32;
	#[name("FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE_PARAMETER_LEN")]
	pub static ENTROPY_CODING_METHOD_PARTITIONED_RICE_PARAMETER_LEN: u32;
	#[name("FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE2_PARAMETER_LEN")]
	pub static ENTROPY_CODING_METHOD_PARTITIONED_RICE2_PARAMETER_LEN: u32;
	#[name("FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE_RAW_LEN")]
	pub static ENTROPY_CODING_METHOD_PARTITIONED_RICE_RAW_LEN: u32;
	#[name("FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE_ESCAPE_PARAMETER")]
	pub static ENTROPY_CODING_METHOD_PARTITIONED_RICE_ESCAPE_PARAMETER: u32;
	#[name("FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE2_ESCAPE_PARAMETER")]
	pub static ENTROPY_CODING_METHOD_PARTITIONED_RICE2_ESCAPE_PARAMETER: u32;
}

#[repr(C)]
pub union EntropyCodingMethodData {
	pub partitioned_rice: EntropyCodingMethod_PartitionedRice,
}

#[repr(C)]
pub struct EntropyCodingMethod {
	pub r#type: FLAC__EntropyCodingMethodType,
	pub data: EntropyCodingMethodData,
}

extern "C" {
	#[name("FLAC__ENTROPY_CODING_METHOD_PARTITIONED_RICE2_ESCAPE_PARAMETER")]
	pub static FLAC__ENTROPY_CODING_METHOD_TYPE_LEN; /**< == 2 (bits) */
}
